{
    ...
    double lumi; 
    if      (lepSel == "DE") lumi = 19.602;
    else if (lepSel == "DMu") lumi = 19.549;
    ...
    if (0) { // for individual production
        hasRecoInfo = true;
        hasGenInfo = false;
        ZJetsAndDPS DMuTT(lepSel + "_8TeV_TTJets_dR_5311_test", lumi * 245. * 1000 / 6923750., 1, 1, !doDataEff, ttSyst[0], ttDir[0], ttScale[0], jetPtMin, jetPtMax, ZPtMin, ZEtaMin, ZEtaMax);
    ...
    if (DoWhat == DATA || DoWhat == ALL) {
        ...
        for (unsigned int i(0); i < NSystData; i++) {
            ZJetsAndDPS DMudata(lepSel + "_8TeV_Data_dR_5311_testA_Smeared", 1, 1, 1, doDataEff, dataSyst[i], dataDir[i], 1, jetPtMin, jetPtMax, ZPtMin, ZEtaMin, ZEtaMax);
    ...
    if (DoWhat == TAU || DoWhat == ALL) {
        hasRecoInfo = true; 
        hasGenInfo = true;
        for (unsigned int i(3); i < NSystMC; i++) { 
            ZJetsAndDPS DMuDYTau(lepSel + "_8TeV_DYJets_FromTau_UNFOLDING_dR_5311_Inf3", lumi*3531.8*1000/30459503., 1, 1, !doDataEff, tauSyst[i], tauDir[i], tauScale[i], jetPtMin, jetPtMax, ZPtMin, ZEtaMin, ZEtaMax);
    ...
    if (DoWhat == DYJETS || DoWhat == ALL) {
        ...
        if (doSysRunning) {
            // PU
            ZJetsAndDPS DMuDYMix1(lepSel + "_8TeV_DYJets_MIX_UNFOLDING_dR_5311_Inf3", lumi*3531.8*1000/30459503., 1, 1, !doDataEff, 1, 1, 1, jetPtMin, jetPtMax, ZPtMin, ZEtaMin, ZEtaMax);
            DMuDYMix1.Loop(hasRecoInfo, hasGenInfo, doQCD, doSameSign, doInvMassCut, doBJets, doPUStudy);
            ZJetsAndDPS DMuDYMix2(lepSel + "_8TeV_DYJets_MIX_UNFOLDING_dR_5311_Inf3", lumi*3531.8*1000/30459503., 1, 1, !doDataEff, 1,-1, 1, jetPtMin, jetPtMax, ZPtMin, ZEtaMin, ZEtaMax);
            DMuDYMix2.Loop(hasRecoInfo, hasGenInfo, doQCD, doSameSign, doInvMassCut, doBJets, doPUStudy);

            // jet smearing part
            if (hasGenInfo) { 
                ZJetsAndDPS DMuDYMix3(lepSel + "_8TeV_DYJets_MIX_UNFOLDING_dR_5311_Inf3", lumi*3531.8*1000/30459503., 1, 1, !doDataEff, 4, 1, 1, jetPtMin, jetPtMax, ZPtMin, ZEtaMin, ZEtaMax);
                DMuDYMix3.Loop(hasRecoInfo, hasGenInfo, doQCD, doSameSign, doInvMassCut, doBJets, doPUStudy);
            }
            else { // xsec offsets
                ZJetsAndDPS DMuDYMix4(lepSel + "_8TeV_DYJets_MIX_UNFOLDING_dR_5311_Inf3", lumi*3531.8*1000/30459503., 1, 1, !doDataEff, 3, 1, 0.04, jetPtMin, jetPtMax, ZPtMin, ZEtaMin, ZEtaMax);
                DMuDYMix4.Loop(hasRecoInfo, hasGenInfo, doQCD, doSameSign, doInvMassCut, doBJets, doPUStudy);

                ZJetsAndDPS DMuDYMix5(lepSel + "_8TeV_DYJets_MIX_UNFOLDING_dR_5311_Inf3", lumi*3531.8*1000/30459503., 1, 1, !doDataEff, 3, -1, 0.04, jetPtMin, jetPtMax, ZPtMin, ZEtaMin, ZEtaMax);
                DMuDYMix5.Loop(hasRecoInfo, hasGenInfo, doQCD, doSameSign, doInvMassCut, doBJets, doPUStudy);

            } 

            ZJetsAndDPS DMuDYMix6(lepSel + "_8TeV_DYJets_MIX_UNFOLDING_dR_5311_Inf3", lumi*3531.8*1000/30459503., 1, 1, !doDataEff, 1, 1, 1, jetPtMin, jetPtMax, ZPtMin, ZEtaMin, ZEtaMax);
            DMuDYMix6.Loop(hasRecoInfo, hasGenInfo, doQCD, doSameSign, doInvMassCut, doBJets, doPUStudy);
            ZJetsAndDPS DMuDYMix7(lepSel + "_8TeV_DYJets_MIX_UNFOLDING_dR_5311_Inf3", lumi*3531.8*1000/30459503., 1, 1, !doDataEff, 1,-1, 1, jetPtMin, jetPtMax, ZPtMin, ZEtaMin, ZEtaMax);
            DMuDYMix7.Loop(hasRecoInfo, hasGenInfo, doQCD, doSameSign, doInvMassCut, doBJets, doPUStudy);
        }
    }
    ...
    //        ZJetsAndDPS DMuDYMixPDF(lepSel+"_8TeV_DYJets_MIX_UNFOLDING_dR_5311_Inf3", lumi*3531.8*1000/30459503., 1., 1, !doDataEff, 0, 0, 1, jetPtMin, jetPtMax, ZEtaMin,    ZEtaMax, -30);
    //        DMuDYMixPDF.Loop(0, 1,  doQCD,  doSameSign, doInvMassCut, doBJets, doPUStudy, 0, 0, 1, 0, "NNPDF23_nlo_as_0118.LHgrid", pdfMember);
    //        //DMuDYMixPDF.Loop(0, 1,  doQCD,  doSameSign, doInvMassCut, doBJets, doPUStudy, 0, 0, 1, 0);
    //    }
    //}
    ...
    //        if (lepSel.find("DMu") == string::npos || lepSel.find("DE") == string::npos) {
    //            ZJetsAndDPS DMuDYMix(lepSel + "_8TeV_DYJets_MIX_UNFOLDING_dR_5311_Inf3", lumi*3531.8*1000/30459503., 1., 1, !doDataEff, 0, 0, 1, jetPtMin, jetPtMax, ZPtMin, ZEtaMin, ZEtaMax, 0);
