...
void FuncUnfold(bool isMuon, string variable, int UsedKtermBayes, int UsedKtermSVD, bool doFlat, bool doVarWidth)
{
    ...
    int JetPtMin(30);
    int JetPtMax(0);
    string outputDirectory = "MyPNGFiles/FinalUnfold/";
    TH1::SetDefaultSumw2();

    JetPtMin = 30;
    if (JetPtMin == 30) outputDirectory = "MyPNGFiles/FinalUnfold_30_1000_Toys/";
    else if (JetPtMin == 20) outputDirectory = "MyPNGFiles/FinalUnfold_20_1000_Toys/";
