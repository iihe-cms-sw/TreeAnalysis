...
void FastPlotsRun(string variable, bool logZ, bool decrease, int SVDkterm, int Bayeskterm, bool closureTest, int JetPtMin, int JetPtMax, bool doFlat, bool doVarWidth)
{
  ...
  else DataFile = getFile(FILESDIRECTORY, leptonFlavor, energy, DYMADGRAPHFILENAME, JetPtMin, JetPtMax, doFlat, doVarWidth, , , "_Even");
  ...
  else DY = getFile(FILESDIRECTORY, leptonFlavor, energy, DYMADGRAPHFILENAME, JetPtMin, JetPtMax, doFlat, doVarWidth, , , "_Odd");
