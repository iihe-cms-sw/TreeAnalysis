...
{
  cout << " I entered the plottingFunctions.cc" << sLegend[0] << endl;
gStyle->SetOptStat(0);
  // create ratios
  TH1D* hRatio[10];
...
//    histos[1]->GetXaxis()->SetLimits(lowerLimit, histos[0]->GetXaxis()->GetXmax());
   ...
   legend->AddEntry(histos[2], sLegend[2].c_str(), "pl");
...
//   hRatio[1]->GetXaxis()->SetLimits(lowerLimit, hRatio[1]->GetXaxis()->GetXmax());
   hRatio[1]->GetYaxis()->SetRangeUser(0.41,1.59);
   ...
   hRatio[0]->GetYaxis()->SetRangeUser(0.41,1.59);
   hRatio[1]->Draw("P");
...
//   hRatio[2]->GetXaxis()->SetLimits(lowerLimit, hRatio[2]->GetXaxis()->GetXmax());
   ...
   hRatio[2]->GetYaxis()->SetRangeUser(0.41,1.59);
