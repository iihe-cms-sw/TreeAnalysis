    ...
    */
    ...
    for (Long64_t jentry(0); jentry < nentries; jentry++){
        ...
        if (fileName.find("MIX") != string::npos && nup_ > 5){
            ...
            else if ( fileName.find("WJets") != string::npos  && fileName.find("Mu") != string::npos ) weight *= mixingWeightsWJ_SMu[nup_ - 6]; 
            else if ( fileName.find("WJets") != string::npos  && fileName.find("E") != string::npos ) weight *= mixingWeightsWJ_SE[nup_ - 6]; 
...
*/
        ...
        if (hasRecoInfo) {
            ...
            for (unsigned short i(0); i < nTotJets; i++){
                ...
                if (doBJets == 1 && patJetPfAk05OCSV_->at(i) < 0.679 )  continue ;
