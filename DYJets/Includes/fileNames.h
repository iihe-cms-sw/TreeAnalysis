...
const int NFilesDYJets = 11 ;
int FilesDYJets[NFilesDYJets] = { 0, 13, 11, 14, 15, 16, 17 , 18, 19 ,  20, 21 };
/*processInfoStruct ProcessInfoDY[NFilesDYJets] = {
  ProcessInfo[0], 
  };
*/
//-- file names ---------------------------------------
