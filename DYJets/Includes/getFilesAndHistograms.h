...
TFile* getFile(string histoFilesDirectory, string leptonFlavor, string energy, string Name, 
        ...
        int doQCD = 0 ,  bool doInvMassCut = false , string closureTest = "", string syst = "0", bool dodR = false);
...
void getStatistics(string leptonFlavor = "Muons", int JetPtMin = 30, int JetPtMax = 0, bool doFlat = false, bool doVarWidth = true);
#endif
