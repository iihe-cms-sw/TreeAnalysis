...
string getEnergy();
TFile* getFile(string, string, string, string, int JetPtMin = 20, int JetPtMax = 0, bool doFlat = false, bool doVarWidth = false, int doQCD = 0 ,  bool doSSign = false , bool doInvMassCut = false , int MET = 0 , string closureTest = "", string syst = "0", bool dodR = false,bool useUnfoldingFiles = false );
void getFiles(string, TFile *Files[], string, string, string, int JetPtMin = 20, int JetPtMax = 0, bool doFlat = false ,  bool doVarWidth = false , int doQCD = 0,  bool doSSign = false , bool doInvMassCut = false, int MET = 0  ,bool useUnfoldingFiles = false );
...
void getStatistics(string leptonFlavor = "Muons",  int JetPtMin = 30, int JetPtMax = 0,  bool doFlat = false , bool doVarWidth = true, int doQCD = 0 , bool doSSign = false ,  bool doInvMassCut = false , int MET = 0 );
