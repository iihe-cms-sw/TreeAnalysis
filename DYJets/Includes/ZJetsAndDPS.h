...
ClassImp(HistoSet)
    ...
    class ZJetsAndDPS: public HistoSet {
        public :
            ...
            ZJetsAndDPS(string fileName_, float lumiScale_ = 1., float puScale_ = 1., bool useTriggerCorrection_ = 0, bool useEfficiencyCorrection_ = 0, 
                    int systematics_ = 0, int direction_ = 0, float xsecfactor_ = 1., int jetPtCutMin_ = 20, int jetPtCutMax_ = 0, int ZEtaCutMin_ = -999999, int ZEtaCutMax_ = 999999, bool nEvents_10000 = 0, int jetEtaCutMin_ = -24, int jetEtaCutMax_ = 24) ; 
            ~ZJetsAndDPS();
            //string   CreateOutputFileName(bool, bool, int, bool, bool, int, bool, bool, int );
            string   CreateOutputFileName(bool, bool, int, bool, bool, int, bool, bool );
            Int_t    Cut(Long64_t entry);
            Int_t    GetEntry(Long64_t entry);
            Long64_t LoadTree(Long64_t entry);
            void     Init(bool hasRecoInfo, bool hasGenInfo, bool hasPartonInfo);
            //void     Loop(bool hasRecoInfo = 1, bool hasGenInfo = 0, int doQCD = 0, bool doSSign = 0, bool doInvMassCut = 1 ,  int doMETcut = 0 , bool doBJets = 0, int doPUStudy = -10,bool doFlat = 0, bool useRoch = 0, bool doVarWidth = 1, bool hasPartonInfo = 0);
